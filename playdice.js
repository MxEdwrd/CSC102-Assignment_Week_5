function playdice(){ //Defines the game name that HTML references.
    ...
    if(dicesum == 7 || dicesum == 11){ //Translation: If dicesum is equal to 7 or equal to 11...
    ...
    else if (die1 == die2 && die1%2 == 0){ //Translation: Otherwise, if die1 is equal to die2 and they are even numbers... (if die1 is divisible by 2)
    ...
    else { //Translation: Otherwise... (do this if everything else has been exhausted)
